""" Template for STL-10 CURL training
"""
import torch
...
if __name__ == '__main__':
    ...
    # These aren't used for this dataset
    labeledfrac = '0.001'
    unlabeledfrac = '0.01'
    ...
    curltrainer = curl.CURL(datasets.STL10,
                            ...
                            testsplit='test',
                            suptrainsplit='train',
                            curltrainsplit='train+unlabeled',
                            groundtruth=False,
    ...
    simfile = f"CURL/STL10/plots/sim.npy"
    contfile = f"CURL/STL10/plots/cont.npy"
