...
if __name__ == '__main__':
    ...
    traincurl = Train_CURL(svhn_path, curlfrac=0.04, supfrac=0.002, k=5, shuffle=True, augment=True, use_cuda=True)
    #for i in range(1):
    ...
    supfile = "plots/sup-04-002.npy"
    curlfile = "plots/unsup-04-002.npy"
