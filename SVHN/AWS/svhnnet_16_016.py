...
if __name__ == '__main__':
    ...
    traincurl = Train_CURL(svhn_path, curlfrac=0.16, supfrac=0.016, k=5, shuffle=True, augment=True, use_cuda=True)
    #for i in range(1):
    ...
    supfile = "plots/sup-16-016.npy"
    curlfile = "plots/unsup-16-016.npy"
