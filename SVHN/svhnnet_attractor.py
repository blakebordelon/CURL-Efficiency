...
class Train_CURL():
    ...
    def curltrain(self, batch_size=8, epochs=10, loss_freq=1):
        ...
        self.bulk.train()
        trainloader = torch.utils.data.DataLoader(self.curltrainset, batch_size=batch_size, sampler=self.suptrain_sampler, num_workers=2)  # We are passing the suptrain_sampler ON PURPOSE here.
...
if __name__ == '__main__':
    ...
    traincurl.curltrain(epochs=4000, batch_size=5)
    _, postcurl_acc = traincurl.suptrain(epochs=1000, batch_size=5,  test_freq=1000)

    supfile = "plots/attractor-0015.npy"
    curlfile = "plots/attractor-04-0015.npy"
