...
supacc2 = np.load('imp-0015.npy')
curlacc2 = np.load('imp-04-0015.npy')
...
run2 = ax.plot(curlbatches2, curlacc2, c='C2', label='110 labeled, 2930 unlabeled no cheat')
ax.plot([supbatches2[-1],curlbatches2[0]], [supacc2[-1],curlacc2[0]], c='b', label='CURL')
ax.set_title("Boost from CURL")
